...
import { startGitPollScheduler } from "./services/git-poll-scheduler.service";
...
/**
 * Replace the default JSON parser with one that accepts an empty body.
 *
 * Fastify's own parser rejects a zero-length body with a 400, but several
 * routes here are legitimately called with no payload at all.
 */
